...
The user guide of **spNetwork** package provide a comprehensive discussion of [*nkde()*](https://jeremygelb.github.io/spNetwork/articles/NKDE.html). You should read them at least once to have a basic understanding of the various parameters that can be used to calibrate the NKDE model.
