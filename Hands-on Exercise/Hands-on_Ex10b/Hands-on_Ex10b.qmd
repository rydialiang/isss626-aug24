...
![In this section, you will learn how to compute a distance matrix by using URA Master Plan 2019 Planning Subzone boundary in which you saved as an rds file called *mpsz*.](images/clipboard-1475824881.png)
...
-   Consistency in reference point (centroid), instead of shortest distance to the edge of the polygon, which may be difficult to compute as there are multiple points along the edge of the polygons.
:::
